export const translations = {
  de: {
    ...
    gallery: {
      ...
      img_32173834_alt: "Apartment-Ausstattung",
      img_32173834_desc: "Ausstattung im Apartment.",
      img_32162735_alt: "Apartment Type-21 Wohnbereich",
      img_32162735_desc: "Apartment Type-21 Wohnbereich.",
      img_32162754_alt: "Duschbad Apartment Type-21",
      img_32162754_desc: "Duschbad in Apartment Type-21 (kleines Apartment).",
      img_32162778_alt: "Apartment Type-25 Eingang",
      img_32162778_desc: "Apartment Type-25 (größeres Apartment mit zwei Ebenen).",
      img_32162786_alt: "Apartment Type-25 Arbeitsplatz",
      img_32162786_desc: "Eingang Apartment Type-25 mit Arbeitsplatz und Schrank.",
      img_32162794_alt: "Apartment Type-25 obere Ebene",
      img_32162794_desc: "Obere Ebene Apartment Type-25.",
      img_32174044_alt: "Schlafbereich Apartment Type-25",
      img_32174044_desc: "Schlafbereich obere Ebene Apartment Type-25.",
      img_32162840_alt: "WC Apartment Type-25",
      img_32162840_desc: "Oberes WC Apartment Type-25.",
      img_32162845_alt: "Wohnbereich Apartment Type-25",
    ...
    map: {
      ...
      location: "Standort",
      wohnheimAddress: "Wohnheim Adresse",
      officeAddress: "LiveIn-WG.de Büro",
      openMaps: "Route in Google Maps öffnen",
    },
    // Contact Section
    contact: {
      label: "Kontakt",
      title: "Wir stehen Ihnen gerne zur Verfügung!",
      description1:
    ...
    footer: {
      description:
        "Möblierte Apartments im Neubau für Langzeitaufenthalter in Karlsruhe. Ideal für Gastarbeiter und Mitarbeiter von KIT, Siemens und weiteren Unternehmen.",
      navigation: "Navigation",
      linksContact: "Links & Kontakt",
      impressum: "Impressum",
      wohnheimLocation: "Wohnheim Standort",
      office: "Büro",
  ...
  en: {
    ...
    apartments: {
      ...
      inquire: "Inquire",
      persons12: "1-2 Persons",
      persons2plus: "2+ Persons",
      shower: "Shower Room",
      showerWC: "Shower + WC",
      furnished: "Furnished",
      wifi: "WiFi",
    ...
    gallery: {
      ...
      img_32173834_alt: "Apartment Amenities",
      img_32173834_desc: "Amenities in the apartment.",
      img_32162735_alt: "Apartment Type-21 Living Area",
      img_32162735_desc: "Apartment Type-21 living area.",
      img_32162754_alt: "Shower Room Apartment Type-21",
      img_32162754_desc: "Shower room in Apartment Type-21 (small apartment).",
      img_32162778_alt: "Apartment Type-25 Entrance",
      img_32162778_desc: "Apartment Type-25 (larger apartment with two levels).",
      img_32162786_alt: "Apartment Type-25 Workspace",
      img_32162786_desc: "Entrance of Apartment Type-25 with workspace and closet.",
      img_32162794_alt: "Apartment Type-25 Upper Level",
      img_32162794_desc: "Upper level of Apartment Type-25.",
      img_32174044_alt: "Sleeping Area Apartment Type-25",
      img_32174044_desc: "Sleeping area on the upper level of Apartment Type-25.",
      img_32162840_alt: "WC Apartment Type-25",
      img_32162840_desc: "Upper WC in Apartment Type-25.",
      img_32162845_alt: "Living Area Apartment Type-25",
    ...
    map: {
      ...
      description:
        "You've already found your way to us virtually. We're glad about that. And so you can visit us in person, we have a map ready for you here.",
      location: "Location",
      wohnheimAddress: "Residence Address",
      officeAddress: "Gatermann Office",
    ...
    contact: {
      ...
      description1:
        "Feel free to contact us. We're happy to provide more details on specific matters, and we'll find a solution together for individual concerns.",
      description2:
        "In any case, we're here to help with advice, action and answers. We're always open to criticism and suggestions, wishes and proposals for change.",
      phone: "By Phone",
      email: "Email",
      written: "By Mail",
    ...
    footer: {
      description:
        "Furnished apartments in a new building for long-term stays in Karlsruhe. Ideal for guest workers and employees of KIT, Siemens and other companies.",
      navigation: "Navigation",
      linksContact: "Links & Contact",
      impressum: "Legal Notice",
      wohnheimLocation: "Residence Location",
      office: "Office",
